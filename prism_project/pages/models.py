...
class Page(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.SET(get_sentinel_user())) # page should show who edited it and display "deleted" if the user has since been deleted
